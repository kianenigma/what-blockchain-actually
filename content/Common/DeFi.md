...
- Decentralized Exchanges (DEX) to trade tokens. The tokens can be
	...
	- Any other value-bearing digital *asset* like NFT and game assets
	- Any value-bearing digital *commodity* like storage, GPUs, and computation
- Borrowing and lending against any tokens
- Stable-coins