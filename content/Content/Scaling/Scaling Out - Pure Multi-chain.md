...
In the above diagram, Block N and N+1 is essentially being processed in parallel, as if we have a 2-core CPU.
...
- We must in some way ensure that there is no conflicting updates in what happened in Block N and N+1 and deal with them, as they are processed in parallel.
